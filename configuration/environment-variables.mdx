...
<ParamField path="ASC_SIGNING_SYNC_PASSWORD" type="string">
  ...
  Prefer `--password-file` on developer machines. The older
  `ASC_MATCH_PASSWORD` variable remains compatible through 4.x with a
  deprecation warning and will be rejected in 5.0.0.
</ParamField>
