...
func TestLocalizationsUpdateClearsNullableFields(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			args:         []string{"--type", "app-info", "--id", "loc-1", "--clear-subtitle"},
		...
		},
		{
			...
			args:         []string{"--type", "app-info", "--id", "loc-1", "--clear-privacy-policy-url"},
			path:         "/v1/appInfoLocalizations/loc-1",
		...
		},
		{
			...
			args:         []string{"--type", "app-info", "--id", "loc-1", "--name", "New Name", "--clear-subtitle"},
			path:         "/v1/appInfoLocalizations/loc-1",
		...
		},
		{
			...
			args:         []string{"--id", "loc-1", "--clear-promotional-text"},
