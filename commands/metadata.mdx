...
When `--version` is omitted, the app's newest editable App Store version
(`PREPARE_FOR_SUBMISSION`, `DEVELOPER_REJECTED`, `REJECTED`,
`METADATA_REJECTED`, `READY_FOR_REVIEW`, `WAITING_FOR_REVIEW`, or
`INVALID_BINARY`) is used,
...
* `--version` - App version string (e.g., `1.2.3`); defaults to the editable version, else the live version
