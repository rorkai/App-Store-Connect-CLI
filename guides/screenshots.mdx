...
For CI or large locale batches, save the printed failure artifact as a workflow artifact so a rerun can continue with `asc screenshots upload --resume <artifact>`.
